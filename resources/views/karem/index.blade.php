  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.html"><img src="assets/images/logo1.jpg" alt="logo" class="logo"></a>
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								...
								<p><a href="{{ route('shop.index') }}" class="btn btn-secondary me-2">Shop Now</a><a href="" class="btn btn-white-outline">Explore</a></p>
							</div>
						</div>
						<div class="col-lg-7">
				...
				<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
						<a class="product-item" href="cart">
							<img src="assets/images/image1.JPG" class="img-fluid product-thumbnail">
